...
export const URL = "https://random-acts0519.herokuapp.com/";
...
export const addActs = (newAct, token) => dispatch => {
    ...
    return axios
        ...
        .then(res => {
            dispatch({
                type: ADD_ACTS_SUCCESS,
                payload: res.data
            });
        })
        .catch(err => {
            dispatch({
                type: ADD_ACTS_FAILED,
                payload: err.response
            });
            alert("Something is wrong, please try again");
        });
...
export const deleteActs = (actId, token) => dispatch => {
    ...
    return axios
        ...
        .then(res => {
            dispatch({
                type: DELETE_ACTS_SUCCESS,
                payload: res.data
            });
        })
        .catch(err => {
            dispatch({
                type: DELETE_ACTS_FAILED,
                payload: err.response
            });
            alert("Failed to delete project, please try again");
        });
...
export const updateActs = (userId, act, token) => dispatch => {
    ...
    return axios
        ...
        .then(res => {
            dispatch({
                type: UPDATE_ACTS_SUCCESS,
                payload: res.data
            });
        })
        .catch(err => {
            dispatch({
                type: UPDATE_ACTS_FAILED,
                payload: err.response
            });
            alert("Something is wrong, please try again");
        });
